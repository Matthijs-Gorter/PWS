...
\section{Q-Learning}
Q-Learning is een reinforcement learning algoritme dat gebruik maakt van een
Q-tabel. Hierin de Q-waarden voor alle combinaties van toestanden en actie's. Met behulp van deze tabel
kiest agent de volgende actie.
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=1cm, auto, >=latex']
        ...
        \tikzstyle{decision} = [rectangle, minimum width=1.5cm, minimum height=0.5cm, text centered, draw=black, fill=green!30]
        ...
        \node (executeaction) [process, below of=decideexplore, yshift=-1.5cm] {Voer Actie Uit en Update Richting};
...
In dit document wordt het Q-learning algoritme beschreven in Algoritme  \ref{alg:Q-learning}.
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=1cm, auto, >=latex']
        ...
        % Knopen plaatsen
        \node (start) [startstop] {Start Training};
        \node (initNetwork) [process, below of=start] {Initialiseer Q-Network en hyperparameters};
        \node (initMemory) [process, below of=initNetwork] {Initialiseer Experience Replay Buffer};
        \node (startEpisode) [process, below of=initMemory] {Start nieuwe episode};
        \node (episodeInit) [process, below of=startEpisode] {Initialiseer game variabele};
        \node (startTimestep) [process, below of=episodeInit] {Start nieuwe tijdstap};
        \node (getstate) [process, below of=startTimestep] {Verzamel Huidige Staat};
        \node (decideexplore) [decision, below of=getstate, yshift=-0.25cm] {Is Actie Exploratie?};
        \node (explore) [process, below left=of decideexplore, xshift=1cm] {Kies Willekeurige Actie};
        \node (exploit) [process, below right=of decideexplore, xshift=-1cm] {Kies Actie via Q-Network};
        \node (executeaction) [process, below of=decideexplore, yshift=-1.5cm] {Voer Actie Uit en Update Richting};
        \node (determinereward) [process, below of=executeaction] {Bepaal Beloning en Volgende Staat};
        \node (storememory) [process, below of=determinereward] {Sla in Replay Buffer op};
        \node (updatenetwork) [process, below of=storememory] {Update Q-Network met Replay Buffer};
        \node (checkgameover) [decision, below of=updatenetwork] {Is het Spel Afgelopen?};
        \node (checktrainingover) [decision, below of=checkgameover, yshift=-0.5cm] {Is de training Afgelopen?};
        \node (stop) [startstop, below of=checktrainingover, yshift=-0.5cm] {Einde};

        % Pijlen tekenen
        \draw [arrow] (start) -- (initNetwork);
        \draw [arrow] (initNetwork) -- (initMemory);
        \draw [arrow] (initMemory) -- (startEpisode);
        \draw [arrow] (startEpisode) -- (episodeInit);
        \draw [arrow] (episodeInit) -- (startTimestep);
        \draw [arrow] (startTimestep) -- (getstate);
        \draw [arrow] (getstate) -- (decideexplore);
        ...
        \draw [arrow] (exploit) |- (executeaction);
        \draw [arrow] (executeaction) -- (determinereward);
        \draw [arrow] (determinereward) -- (storememory);
        \draw [arrow] (storememory) -- (updatenetwork);
        \draw [arrow] (updatenetwork) -- (checkgameover);
        \draw [arrow] (checkgameover) -- node[anchor=east] {Ja} (checktrainingover);
        \draw [arrow] (checkgameover) -| node[pos=0.05, anchor=north, align=center] {Nee} (7.5,-5) -- (startTimestep);
        \draw [arrow] (checktrainingover) -- node[anchor=east] {Ja} (stop);
        \draw [arrow] (checktrainingover) -| node[pos=0.05, anchor=north, align=center] {Nee} (8,-3) -- (startEpisode);
    \end{tikzpicture}
    \caption{Flowchart van het DQN Algoritme}\label{fig:dqn_flowchart}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=1cm, auto, >=latex']
        ...
        % Knopen plaatsen
        \node (start) [startstop] {Start Training};
        \node (initNetworks) [process, below of=start] {Initialiseer Actor, Critic en Target Netwerken};
        \node (initMemory) [process, below of=initNetworks] {Initialiseer Experience Replay Buffer};
        \node (startEpisode) [process, below of=initMemory] {Start nieuwe episode};
        \node (episodeInit) [process, below of=startEpisode] {Initialiseer game variabele};
        \node (startTimestep) [process, below of=episodeInit] {Start nieuwe tijdstap};
        \node (getstate) [process, below of=startTimestep] {Verzamel Huidige Staat};
        \node (decideexplore) [decision, below of=getstate, yshift=-0.25cm] {Is Actie Exploratie?};
        \node (explore) [process, below left=of decideexplore, xshift=1cm] {Kies Willekeurige Actie (Exploratie)};
        \node (exploit) [process, below right=of decideexplore, xshift=-2cm] {Kies Actie via Actor Netwerk};
        \node (executeaction) [process, below of=decideexplore, yshift=-1.5cm] {Voer Actie Uit en Verzameld Resultaat};
        \node (determinereward) [process, below of=executeaction] {Bepaal Beloning en Volgende Staat};
        \node (storememory) [process, below of=determinereward] {Sla in Replay Buffer op};
        \node (updatenetworks) [process, below of=storememory] {Update Actor en Critic Netwerken met Replay Buffer};
        \node (updatetargets) [process, below of=updatenetworks] {Update Actor en Critic Target Netwerken};
        \node (checkgameover) [decision, below of=updatetargets] {Is het Spel Afgelopen?};
        \node (checktrainingover) [decision, below of=checkgameover, yshift=-0.5cm] {Is de training Afgelopen?};
        \node (stop) [startstop, below of=checktrainingover, yshift=-0.5cm] {Einde};

        % Pijlen tekenen
        \draw [arrow] (start) -- (initNetworks);
        \draw [arrow] (initNetworks) -- (initMemory);
        \draw [arrow] (initMemory) -- (startEpisode);
        \draw [arrow] (startEpisode) -- (episodeInit);
        \draw [arrow] (episodeInit) -- (startTimestep);
        \draw [arrow] (startTimestep) -- (getstate);
        ...
        \draw [arrow] (executeaction) -- (determinereward);
        \draw [arrow] (determinereward) -- (storememory);
        \draw [arrow] (storememory) -- (updatenetworks);
        \draw [arrow] (updatenetworks) -- (updatetargets);
        \draw [arrow] (updatetargets) -- (checkgameover);
        \draw [arrow] (checkgameover) -- node[anchor=east] {Ja} (checktrainingover);
        \draw [arrow] (checkgameover) -| node[pos=0.05, anchor=north, align=center] {Nee} (7.5,-5) -- (startTimestep);
        \draw [arrow] (checktrainingover) -- node[anchor=east] {Ja} (stop);
        \draw [arrow] (checktrainingover) -| node[pos=0.05, anchor=north, align=center] {Nee} (8,-3) -- (startEpisode);
    \end{tikzpicture}
    \caption{Flowchart van het DDPG Algoritme}\label{fig:ddpg_flowchart}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=1cm, auto, >=latex']
        ...
        % Knopen plaatsen
        \node (start) [startstop] {Start Training};
        \node (initNetwork) [process, below of=start] {Initialiseer Policy-Value Netwerk};
        \node (startEpisode) [process, below of=initNetwork] {Start Zelf-Spel Episode};
        \node (episodeInit) [process, below of=startEpisode] {Initialiseer Bordconfiguratie};
        \node (startTimestep) [process, below of=episodeInit] {Start nieuwe tijdstap};
        \node (mcts) [process, below of=startTimestep] {Voer Monte Carlo Boomzoek uit};
        \node (selectaction) [process, below of=mcts] {Kies Actie via MCTS Beleidsdistributie};
        \node (executeaction) [process, below of=selectaction] {Voer Actie Uit en Verander Bordconfiguratie};
        \node (checkgameover) [decision, below of=executeaction] {Is het Spel Afgelopen?};
        \node (storegame) [process, below of=checkgameover, yshift=-0.5cm] {Sla het Spel en Resultaten op};
        \node (trainnetwork) [process, below of=storegame, yshift=-0.5cm] {Train Netwerk op Zelf-Spel Data};
        \node (checktrainingover) [decision, below of=trainnetwork, yshift=-0.5cm] {Is de training Afgelopen?};
        \node (stop) [startstop, below of=checktrainingover, yshift=-0.5cm] {Einde};

        % Pijlen tekenen
        \draw [arrow] (start) -- (initNetwork);
        \draw [arrow] (initNetwork) -- (startEpisode);
        \draw [arrow] (startEpisode) -- (episodeInit);
        \draw [arrow] (episodeInit) -- (startTimestep);
        \draw [arrow] (startTimestep) -- (mcts);
        \draw [arrow] (mcts) -- (selectaction);
        \draw [arrow] (selectaction) -- (executeaction);
        \draw [arrow] (executeaction) -- (checkgameover);
        \draw [arrow] (checkgameover) -- node[anchor=east] {Ja} (storegame);
        \draw [arrow] (checkgameover) -| node[anchor=north] {Nee} (startTimestep);
        \draw [arrow] (storegame) -- (trainnetwork);
        \draw [arrow] (trainnetwork) -- (checktrainingover);
        \draw [arrow] (checktrainingover) -- node[anchor=east] {Ja} (stop);
        \draw [arrow] (checktrainingover) -| node[anchor=north] {Nee} (startEpisode);
    \end{tikzpicture}
    \caption{Flowchart van het AlphaZero Algoritme}\label{fig:alphazero_flowchart}
\end{figure}
