...
\begin{figure}[h]
    \centering
    \subfloat[Gemiddelde appels per episode]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
        \label{fig:q_learning_apples}}
    \hfill
    \subfloat[Exploratiepercentage ($\varepsilon$)]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
        \label{fig:q_learning_epsilon}}
...
\begin{figure}[h]
    ...
    \subfloat[Gemiddelde appels per episode]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
        \label{fig:dqn_apples}}
    \hfill
    \subfloat[Training loss curve]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
        \label{fig:dqn_loss}}
...
\begin{figure}[h]
    \centering
    \subfloat[Policy-entropie]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
        \label{fig:ppo_entropy}}
    \hfill
    \subfloat[Gemiddelde cumulatieve beloning]{
        \includegraphics[width=0.45\textwidth]{../Experimenten/Experiment1Snake/DQN/dqn_analysis.png}
