...
% \chapter{Gedetailleerde Analyse per Algoritme}
% \label{app:deepdive}

% Dit appendix bevat uitgebreide analyses en ondersteunende figuren voor de drie geteste RL-algoritmes.

% \section{Q-learning}
% \label{app:q_learning}

% \begin{figure}[htbp]
%     \centering
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{q_epsilon_decay.png}
%         \caption{Epsilon decay schema en effect op exploratie}
%         \label{fig:q_epsilon}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{q_loss_progression.png}
%         \caption{TD-loss ontwikkeling per 100 episodes}
%         \label{fig:q_loss}
%     \end{subfigure}
    
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{q_steps_per_apple.png}
%         \caption{Stijging in benodigde stappen per appel na 8k episodes}
%         \label{fig:q_steps}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{q_apple_distribution.png}
%         \caption{Histogram van appels/episode in verschillende trainingsfasen}
%         \label{fig:q_dist}
%     \end{subfigure}
%     \caption{Gedetailleerde Q-learning trainingsdynamiek. De vroege fase (0-5k episodes) vertoont snelle vooruitgang, gevolgd door suboptimaal exploratiegedrag.}
%     \label{fig:q_full}
% \end{figure}

% Belangrijke observaties:
% \begin{itemize}
%     \item Sterke correlatie ($r = -0.89$) tussen epsilon-waarde en gemiddelde stappen/appel na 10k episodes
%     \item 73\% van de totale reward wordt behaald in de eerste 40\% van de training
%     \item Q-waarde divergentie treedt op bij leerratio's > 0.3 (zie Figuur~\ref{fig:q_loss})
% \end{itemize}
...
%         \includegraphics[width=\textwidth]{dqn_training_loss.png}
%         \caption{Training loss met periodieke stabilisaties}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.32\textwidth}
%         \includegraphics[width=\textwidth]{dqn_eval_vs_train.png}
%         \caption{Performantiekloof tussen training en evaluatie}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.32\textwidth}
%         \includegraphics[width=\textwidth]{dqn_replay_buffer.png}
%         \caption{Replay buffer sampling distributie}
%     \end{subfigure}
    
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{dqn_hyperparam.png}
%         \caption{Hyperparameter gevoeligheid (batchgrootte vs. leerratio)}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{dqn_spatial_heatmap.png}
%         \caption{Geleerde positievoorkeuren in game grid}
%     \end{subfigure}
%     \caption{Uitgebreide DQN-analyse toont complexe interacties tussen netwerkarchitectuur en trainingsdynamiek.}
%     \label{fig:dqn_full}
% \end{figure}

% Opvallende patronen:
% \begin{itemize}
%     \item Target network updates veroorzaken karakteristieke loss-pieken om de 1.500 episodes
%     \item Optimale batchgrootte van 64 geeft 23\% snellere convergentie t.o.v. 32/128
%     \item Replay buffer bevat slechts 12\% "hoog-reward" transitions na convergentie
% \end{itemize}
...
%     \centering
%     \begin{subfigure}[b]{0.32\textwidth}
%         % \includegraphics[width=\textwidth]{ppo_entropy_decay.png}
%         \caption{Entropie-afname per policy update}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.32\textwidth}
%         \includegraphics[width=\textwidth]{ppo_advantages.png}
%         \caption{Advantage waardendistributie}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.32\textwidth}
%         % \includegraphics[width=\textwidth]{ppo_clipping.png}
%         \caption{Effect van clip-range op policy updates}
%     \end{subfigure}
    
%     \begin{subfigure}[b]{0.49\textwidth}
%         % \includegraphics[width=\textwidth]{ppo_trajectories.png}
%         \caption{Voorbeeld trajectories in verschillende trainingsstadia}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         % \includegraphics[width=\textwidth]{ppo_hyperparam_impact.png}
%         \caption{Hyperparameter trade-off analyse}
%     \end{subfigure}
%     \caption{PPO-specifieke trainingskarakteristieken tonen stabiele maar compute-intensieve leercurves.}
%     \label{fig:ppo_full}
% \end{figure}

% Kerninzichten:
% \begin{itemize}
%     \item Entropie daalt exponentieel ($R^2 = 0.97$ voor exp. fit) na 200 policy updates
%     \item Clip-range van 0.2 geeft optimale balans tussen stabiliteit en aanpassingssnelheid
%     \item 82\% van de totale reward komt van 15\% van de state-action paren
% \end{itemize}

% \section{Aanvullende Statistieken}
% \label{app:stats}

% \begin{table}[htbp]
%     \centering
%     \caption{Correlatiematrix tussen hyperparameters en prestatiemetrics}
%     \label{tab:correlaties}
%     \begin{tabular}{lrrrrr}
%         \toprule
%         & Leerratio & Batchgrootte & Gamma & Entropiecoëff. & Gem. reward \\
%         \midrule
%         Leerratio & 1.00 & -0.12 & 0.08 & 0.05 & -0.45 \\
%         Batchgrootte & -0.12 & 1.00 & 0.15 & -0.03 & 0.31 \\
%         Gamma & 0.08 & 0.15 & 1.00 & -0.10 & 0.62 \\
%         Entropiecoëff. & 0.05 & -0.03 & -0.10 & 1.00 & 0.18 \\
%         \bottomrule
%     \end{tabular}
% \end{table}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.8\textwidth]{compute_efficiency.png}
%     \caption{Compute-tijd per algoritme (GPU/CPU-gebruik). PPO vereist 3.2× meer compute dan DQN.}
%     \label{fig:compute}
% \end{figure}
